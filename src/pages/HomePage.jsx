...
const services = [
  {
    ...
    description:
      'Planowanie, realizacja i postprodukcja materialow promocyjnych oraz personalnych.',
  },
  {
          ...
          <div className="container hero-grid">
            <AnimatedElement animationType="fadeInRight" delay={160} className="hero-copy">
              ...
              <p className="hero-description">
                Fotograf, filmowiec i projektant tresci. Buduje spojne narracje wizualne dla marek i
                tworczow - od konceptu, przez plan zdjeciowy, po finalny drop online.
              </p>
            ...
            <div className="container">
              <div className="section-intro">
                ...
                <p className="section-description">
                  Kazdy projekt prowadze jak launch nowego produktu: klarowna narracja, miekkie
                  przejscia i dopracowany retusz, ktory swieci na ekranach Retina.
                </p>
              </div>
              ...
              <div className="portfolio-preview">
                <header>
                  ...
                  <p>
                    Historie projektowane w duetach foto i video, wsparte przez szybkie
                    prototypowanie i inteligentna postprodukcje.
                  </p>
                </header>
            ...
            <div className="container">
              <div className="section-intro">
                ...
                <h2 className="section-title">
                  Uslugi zaprojektowane w duchu Apple i Media Narrative
                </h2>
                <p className="section-description">
                  Lacze elegancki minimalizm z energia neonowych akcentow. Realizacje sa modularne,
                  latwe do skalowania i gotowe do adaptacji na kazdy kanal.
                </p>
              </div>
          ...
          <section id="kontakt" className="section">
            <div className="container">
              <div className="section-intro">
                ...
                <p className="section-description">
                  Opisz krotko swoj projekt lub wyzwanie. Wracam z odpowiedzia i pomyslami w ciagu
              ...
              <form className="contact" method="POST" action="#" onSubmit={handleSubmit}>
                ...
                <div className="form-status" aria-live="polite">
                  ...
                  {formState.error && (
                    <div className="form-message form-error">❌ {formState.error}</div>
                  )}
                </div>
              </form>
            </div>
